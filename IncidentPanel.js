    ...
    client.on('interactionCreate', async (interaction) => {
        if (interaction.isButton()) {
            ...
            if (interaction.customId === 'updateIncident') {
                ...
                await interaction.reply({ content: 'Select an incident to update:', components: [new ActionRowBuilder().addComponents(menu)], ephemeral: true });
            }
            ...
            if (interaction.customId === 'removeIncident') {
                ...
                await interaction.reply({ content: 'Select an incident to remove:', components: [new ActionRowBuilder().addComponents(menu)], ephemeral: true });
            }
        }
